...
class TestAPITutorialSchemas:
    ...
    def test_api_tutorial_update_invalid_types(self):
        """Test APITutorialUpdate with invalid data types."""
        with pytest.raises(ValidationError) as exc_info:
            APITutorialUpdate(id="invalid", name="Test")
...
class TestAPISubtableSchemas:
    ...
    def test_api_subtable_invalid_ids(self):
        """Test APISubtable with invalid data types."""
        with pytest.raises(ValidationError) as exc_info:
            APISubtable(
