...
class APISubtableBasic(BaseModel):
    description: str = Field(min_length=1, description="Description of the subtable content")
    author: str = Field(min_length=1, description="Author of the subtable")
...
class APISubtableUpdate(BaseModel):
    id: int | None = Field(None, gt=0, description="Unique identifier for the subtable to update, None for new subtables")
...
class APITutorialUpdate(BaseModel):
    id: int = Field(gt=0, description="Unique identifier for the tutorial to update")
    name: str | None = Field(None, min_length=1, description="Updated name")
